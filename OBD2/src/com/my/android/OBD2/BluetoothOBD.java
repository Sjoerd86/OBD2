 ...
 */
public class BluetoothOBD extends Activity {
    // Debugging
    ...
    protected BluetoothOBDService mChatService = null;
    
    protected dongle dongle1;
    ...
    public synchronized void onResume() {
        ...
        if (mChatService != null) {
            ...
            if (mChatService.getState() == BluetoothOBDService.STATE_NONE) {
    ...
    private void setupChat() {
        ...
        mChatService = new BluetoothOBDService(this, mHandler);
    ...
    public void sendMessage(String message) {
        ...
        if (mChatService.getState() != BluetoothOBDService.STATE_CONNECTED) {
